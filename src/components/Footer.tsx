      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-12 mb-16">
          <div className="col-span-2">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 bg-white/10 backdrop-blur-sm flex items-center justify-center rounded-xl border border-white/20">
                <Hexagon className="text-white w-6 h-6" />
              </div>
              <div>
                <span className="text-lg font-bold text-white">知阁·舟坊</span>
                <div className="text-xs text-blue-200">ZhiGe Dockyard</div>
              </div>
            </div>
            <p className="text-sm text-blue-100 max-w-xs leading-relaxed mb-8">
              全球领先的软件工程效能操作系统，致力于消除研发链路中的低效瓶颈，释放创造力。
            </p>
                ...
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 ease-out z-[100]">
                  <div className="bg-white rounded-2xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3)] p-4 w-48">
                    <div className="bg-gradient-to-br from-red-50 to-transparent p-2 rounded-xl mb-3">
                      <img
                        src="https://api.qrserver.com/v1/create-qr-code/?size=160x160&data=https://zhige-dockyard.com/weibo"
                        alt="微博二维码"
                        className="w-40 h-40 rounded-lg mx-auto"
                      />
                    </div>
          ...
          <div className="space-y-4">
            <h4 className="font-bold text-sm text-white">产品</h4>
          ...
          <div className="space-y-4">
            <h4 className="font-bold text-sm text-white">资源</h4>
            <ul className="text-sm text-blue-100 space-y-2">
              ...
              <li><a href="#/" className="hover:text-white transition-colors">开发者社区</a></li>
            </ul>
          </div>

          <div className="space-y-4">
            <h4 className="font-bold text-sm text-white">解决方案</h4>
            <ul className="text-sm text-blue-100 space-y-2">
              <li><a href="#/" className="hover:text-white transition-colors">政务云</a></li>
              <li><a href="#/" className="hover:text-white transition-colors">军工科研</a></li>
              <li><a href="#/" className="hover:text-white transition-colors">金融信创</a></li>
              <li><a href="#/" className="hover:text-white transition-colors">智慧城市</a></li>
            </ul>
          </div>

          <div className="space-y-4">
            <h4 className="font-bold text-sm text-white">公司</h4>
            <ul className="text-sm text-blue-100 space-y-2">
              <li><a href="#/" className="hover:text-white transition-colors">关于我们</a></li>
              <li><a href="#/" className="hover:text-white transition-colors">联系商务</a></li>
              <li><a href="#/" className="hover:text-white transition-colors">隐私条款</a></li>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="text-[13px] text-blue-200 text-center md:text-left">
            © 2026 ZhiGe OS · 知阁·舟坊 · 京ICP备 2026000000 号-1 · 京公网安备 31000000000000 号
          </div>

...
const COMPONENTS = [
  ...
  { id: "C51", name: "智能推荐", stage: "智能增强", icon: Lightbulb, color: "#8b5cf6", description: "智能推荐系统" },
  { id: "C52", name: "自动化代码", stage: "智能增强", icon: Code, color: "#7c3aed", description: "辅助代码生成" },
  { id: "C53", name: "智能问答", stage: "智能增强", icon: MessageSquare, color: "#6b46c1", description: "智能问答助手" },
];

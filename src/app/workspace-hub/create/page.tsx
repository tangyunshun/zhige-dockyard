      ...
      <main className="relative z-10 px-4 py-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white/90 backdrop-blur-xl rounded-2xl p-6 border border-[#e2e8f0]/80 shadow-xl">
            ...
            {/* 温馨提示 */}
            <div className="mt-3 p-2.5 bg-[#3182ce]/5 rounded-lg border border-[#3182ce]/20">
              <div className="flex items-start gap-2">
                <div className="w-4 h-4 rounded-full bg-[#3182ce] flex items-center justify-center flex-shrink-0 mt-0.5">
                  <span className="text-[9px] font-bold text-white">i</span>
                </div>
                <div className="text-xs text-[#3182ce] leading-relaxed">
                  <p className="font-bold mb-0.5">温馨提示</p>
                  <ul className="space-y-0.5 text-[9px]">
                    <li>• 创建后可在设置中修改大部分信息</li>
                    <li>• 空间标识唯一，创建后不可修改</li>
                    <li>• 创建后可邀请团队成员协作</li>
                  </ul>
                </div>
              </div>
            ...
            {/* 操作按钮 */}
            <div className="mt-3 flex justify-end gap-2 pt-3 border-t border-[#e2e8f0]/80">
              <button
                onClick={() => router.back()}
                className="px-3.5 py-1.5 text-xs font-bold text-slate-700 hover:bg-slate-100 rounded-lg transition-all cursor-pointer"
              >
                取消
              </button>
              <button
